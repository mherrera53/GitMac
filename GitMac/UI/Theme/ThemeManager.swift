...
struct ColorScheme: Codable {
    ...
    static let light = ColorScheme(
        ...
        backgroundSecondary: CodableColor(hex: "#F5F5F7"), // Slightly more visible separation
        backgroundTertiary: CodableColor(hex: "#EBEBED"),  // Even more contrast
        text: CodableColor(hex: "#1D1D1F"),           // Apple dark gray - excellent contrast
        textSecondary: CodableColor(hex: "#48484A"),  // Darker for better readability (was #86868B)
        textMuted: CodableColor(hex: "#6E6E73"),      // Much darker for proper contrast (was #AEAEB2)
        accent: CodableColor(hex: "#007AFF"),
        accentHover: CodableColor(hex: "#0051D5"),
        gitAdded: CodableColor(hex: "#1D8348"),       // Darker green for contrast
        gitModified: CodableColor(hex: "#D68910"),    // Darker orange for contrast
        gitDeleted: CodableColor(hex: "#C0392B"),     // Darker red for contrast
        gitRenamed: CodableColor(hex: "#1A5276"),     // Darker blue for contrast
        gitConflict: CodableColor(hex: "#C2185B"),    // Darker pink for contrast
        gitUntracked: CodableColor(hex: "#5D6D7E"),   // Darker gray for contrast
        branchLocal: CodableColor(hex: "#1D8348"),    // Darker green
        branchRemote: CodableColor(hex: "#1A5276"),   // Darker blue
        branchCurrent: CodableColor(hex: "#D68910"),  // Darker orange
        graphLine1: CodableColor(hex: "#1A5276"),     // Darker blue
        graphLine2: CodableColor(hex: "#1D8348"),     // Darker green
        graphLine3: CodableColor(hex: "#D68910"),     // Darker orange
        graphLine4: CodableColor(hex: "#7B1FA2"),     // Darker purple
        graphLine5: CodableColor(hex: "#C0392B"),     // Darker red
        success: CodableColor(hex: "#1D8348"),        // Darker green
        warning: CodableColor(hex: "#D68910"),        // Darker orange
        error: CodableColor(hex: "#C0392B"),          // Darker red
        info: CodableColor(hex: "#1A5276"),           // Darker blue
        diffAddition: CodableColor(hex: "#1D8348"),   // Darker green for light bg
        diffDeletion: CodableColor(hex: "#C0392B"),   // Darker red for light bg
        diffChange: CodableColor(hex: "#1A5276")      // Darker blue for light bg
    )
    ...
    // System (adaptive) - Uses same improved light theme colors
    static let system = ColorScheme(
        background: CodableColor(hex: "#FFFFFF"),
        backgroundSecondary: CodableColor(hex: "#F5F5F7"),
        backgroundTertiary: CodableColor(hex: "#EBEBED"),
        text: CodableColor(hex: "#1D1D1F"),
        textSecondary: CodableColor(hex: "#48484A"),  // Improved contrast
        textMuted: CodableColor(hex: "#6E6E73"),      // Improved contrast
        accent: CodableColor(hex: "#007AFF"),
        accentHover: CodableColor(hex: "#0051D5"),
        gitAdded: CodableColor(hex: "#1D8348"),
        gitModified: CodableColor(hex: "#D68910"),
        gitDeleted: CodableColor(hex: "#C0392B"),
        gitRenamed: CodableColor(hex: "#1A5276"),
        gitConflict: CodableColor(hex: "#C2185B"),
        gitUntracked: CodableColor(hex: "#5D6D7E"),
        branchLocal: CodableColor(hex: "#1D8348"),
        branchRemote: CodableColor(hex: "#1A5276"),
        branchCurrent: CodableColor(hex: "#D68910"),
        graphLine1: CodableColor(hex: "#1A5276"),
        graphLine2: CodableColor(hex: "#1D8348"),
        graphLine3: CodableColor(hex: "#D68910"),
        graphLine4: CodableColor(hex: "#7B1FA2"),
        graphLine5: CodableColor(hex: "#C0392B"),
        success: CodableColor(hex: "#1D8348"),
        warning: CodableColor(hex: "#D68910"),
        error: CodableColor(hex: "#C0392B"),
        info: CodableColor(hex: "#1A5276"),
        diffAddition: CodableColor(hex: "#1D8348"),
        diffDeletion: CodableColor(hex: "#C0392B"),
        diffChange: CodableColor(hex: "#1A5276")
    )
}
...
class ThemeEditorWindowController {
    ...
    func showWindow() {
        ...
        // Apply theme appearance to window (nil = follow system)

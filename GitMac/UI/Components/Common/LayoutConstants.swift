        ...
        VStack(alignment: .leading, spacing: LayoutConstants.Spacing.lg) {
            ...
            VStack(alignment: .leading, spacing: LayoutConstants.Spacing.md) {
                ...
                HStack(spacing: LayoutConstants.Spacing.sm) {
                    Text("XS").padding(LayoutConstants.Padding.compact).background(Color.blue.opacity(0.2))
                    Text("SM").padding(LayoutConstants.Padding.compact).background(Color.blue.opacity(0.2))
                    Text("MD").padding(LayoutConstants.Padding.compact).background(Color.blue.opacity(0.2))
                    Text("LG").padding(LayoutConstants.Padding.compact).background(Color.blue.opacity(0.2))
                }
            }

    ...
    private var splitDiffView: some View {
        GeometryReader { geometry in
            HStack(spacing: 0) {
                ...
                VStack(spacing: 0) {
                    // Header
                    DiffPaneHeader(title: "Original", color: .red)
                ...
                VStack(spacing: 0) {
                    // Header
                    DiffPaneHeader(title: "Modified", color: .green)
...
struct HunkHeaderView: View {
    ...
    var body: some View {
        ...
        .padding(.horizontal, 12)
        .padding(.vertical, 6)
        .background(isSelected ? Color.accentColor.opacity(0.2) : Color.blue.opacity(0.05))
    }
}

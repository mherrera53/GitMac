...
// MARK: - GitService Integration Example

/*
 Para integrar en GitService.swift, agregar tracking en push/pull/fetch:
...
extension GitService {
    func push(force: Bool = false, setUpstream: Bool = false) async throws {
        ...
        let branchName = currentRepository?.currentBranch?.name ?? "unknown"

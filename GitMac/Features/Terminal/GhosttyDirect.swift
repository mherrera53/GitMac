...
struct GhosttyDirectView: View {
    ...
    private var toolbarView: some View {
        HStack(spacing: 12) {
            ...
            .foregroundColor(Color(hex: "565f89"))
            ...
            .buttonStyle(.plain)
            .foregroundColor(Color(hex: "7aa2f7"))
            .help("AI Assistant")
            ...
            .toggleStyle(.button)
            .buttonStyle(.plain)
            .foregroundColor(aiEnabled ? Color(hex: "7aa2f7") : Color(hex: "565f89"))
            .help("AI Suggestions")
                ...
                HStack(spacing: 8) {
                    ...
                    if suggestion.confidence > 0.8 {
                        Text("HIGH")
                            ...
                            .foregroundColor(Color(hex: "9ece6a"))
                            .padding(.horizontal, 6)
                            .padding(.vertical, 2)
                            .background(Color(hex: "9ece6a").opacity(0.2))
                            .cornerRadius(4)
                    }
                }

...
enum FastMarkdownRenderer {
    ...
    struct Styles {
        ...
        init(isDarkMode: Bool) {
            ...
            h1 = [.font: NSFont.systemFont(ofSize: 26, weight: .bold), .foregroundColor: textColor]
            h2 = [.font: NSFont.systemFont(ofSize: 22, weight: .semibold), .foregroundColor: textColor]
            h3 = [.font: NSFont.systemFont(ofSize: 18, weight: .semibold), .foregroundColor: textColor]
            h4 = [.font: NSFont.systemFont(ofSize: 15, weight: .semibold), .foregroundColor: textColor]
            inlineCode = [.font: codeFont, .foregroundColor: textColor, .backgroundColor: codeBackground]
            codeBlock = [.font: NSFont.monospacedSystemFont(ofSize: 12, weight: .regular), .foregroundColor: textColor, .backgroundColor: codeBackground]
            ...
            hr = [.font: NSFont.systemFont(ofSize: 8), .foregroundColor: NSColor.separatorColor]
        }
    }
}
